...
To give an overview of hosting some example research code which incorporates:
- Some text
- Code
- Visualization
- Methodology
...
# })
# 
# lapply(as.list(names(density.plots)), function(x){
#   if(x %in% c("Cambridgeshire and Peterborough", "Liverpool City Region", "West of England")){
#     ggsave(density.plots[[x]], file=paste0(wd, "/Outputs/", regions[regions$Region==x,]$Save_Name[1], "/DensDeciles_", regions[regions$Region==x,]$Save_Name[1], ".jpeg"), width = 215.9, height = 279.4, units = "mm")
#   } else {
#     ggsave(density.plots[[x]], file=paste0(wd, "/Outputs/", regions[regions$Region==x,]$Save_Name[1], "/DensDeciles_", regions[regions$Region==x,]$Save_Name[1], ".jpeg"), width = 279.4, height = 215.9, units = "mm")
# }})
```
...
# 
# t <- lapply(as.list(unique(regions$Region)), function(p) {
...
#   
#   ggsave(gradient.plots, file=paste0(wd, "/Outputs/", regions[regions$Region==p,]$Save_Name[1], "/Densities.jpeg"), width = 279.4, height = 215.9, units = "mm")
